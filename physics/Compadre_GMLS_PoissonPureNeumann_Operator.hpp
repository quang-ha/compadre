#ifndef _COMPADRE_GMLS_POISSONPURENEUMANN_PHYSICS_HPP_
#define _COMPADRE_GMLS_POISSONPURENEUMANN_PHYSICS_HPP_
...
class GMLS_PoissonPureNeumannPhysics : public PhysicsT {
    protected:
        typedef Compadre::ParticlesT particle_type;
        local_index_type Porder;
    public:
        Teuchos::RCP<GMLS> _solution_neumann_GMLS;
        Teuchos::RCP<GMLS> _solution_all_GMLS;

        Kokkos::View<int*>::HostMirror _internal_filtered_flags;
        Kokkos::View<int*>::HostMirror _boundary_filtered_flags;

        GMLS_PoissonPureNeumannPhysics(Teuchos::RCP<particle_type> particles, local_index_type t_Porder,
        ...
        virtual ~GMLS_PoissonPureNeumannPhysics() {}
